      ...
      console.log(
        Object.keys(challenge.requirements).reduce(
          (x, y) =>
            ...
            compareCredentials(DUMMY_CREDENTIALS[y], challenge.requirements[y]),
          true
        )
      );
    ...
    return (
      <div className='challenge-container'>
        <Card className='challenge'>
          ...
          >
            <p>
              Do you want to proceed and delete this challenge? Please note that
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <th>
                  {challenge.owner.charAt(0).toUpperCase() +
